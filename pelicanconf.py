...
HERO = [
    {
        ...
        "text": "Data Scientist | Math Enthusiast | Knowledge Junkie",
        "links": [],
    },
    # {
...
SOCIAL = (
    ...
    ("Github", "https://github.com/panchgonzalez"),
)

ABOUT = {
    # 'image': '/images/about/about.jpg',
    "mail": "me@franciscojgonzalez.com",
    # keep it a string if you dont need multiple languages
...
# setup disqus
DISQUS_SHORTNAME = "francisco-j-gonzalez"
DISQUS_ON_PAGES = (
    False
)  # if true its just displayed on every static page, like this you can still enable it per page
